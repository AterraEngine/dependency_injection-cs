...
public class VersionBumpCommands : ICommandAtlas {
    ...
    private async static Task<SuccessOrFailure<string>> BumpVersion(VersionBumpParameters args) {
        string[] projectFiles = [
            "src/AterraEngine.DependencyInjection/AterraEngine.DependencyInjection.csproj", 
            "src/AterraEngine.DependencyInjection.Generators/AterraEngine.DependencyInjection.Generators.csproj"
        ];
